...
async function setup(){
    ...
    rectMode(CORNER);
     ...
     //Bar Chart
     graphs.push(new barChart(100, 500, 400, 400, data, data.getRowCount(), 10, 10, -5, 5, "Car Makes", "AVG sales"));

     //Stacked Chart
     graphs.push(new StackedBarChart(700, 500, 400, 400, data, data.getRowCount(), 10, 10, -5, 5, "Car Makes", "Sales"));

     //Lined Bar Chart
     graphs.push(new linedBarChart(100, 1050, 400, 400, data, data.getRowCount(), 10, 10, -5, 5, "Car Makes", "Sales"));

     //Horizontal Bar Chart
     graphs.push(new HorizontalBarChart(700, 1050, 400, 400, data, data.getRowCount(), 10, 10, -5, 5, "Sales", "Car Makes"));

     //Horizontal Stacked Chart
     graphs.push(new HorizontalStackedChart(700, 1600, 400, 400, data, data.getRowCount(), 10, 10, -5, 5, "Sales", "Car Makes"));

     graphs.push(new LineGraph(100, 1600, 400, 400, data, data.getRowCount(), 10, 10, -5, 5, "Car Makes", "Sales"));
...
function draw(){
    ...
    drawTitle("Stacked Bar Chart to display sales for each car make for 3 different years including average line", 880, 50, 12, "black");
